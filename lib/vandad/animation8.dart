            ...
            children: [
              ...
              Transform(
                ...
                transform: Matrix4.identity()
                  ..setEntry(3, 2, 0.001)
                  ..translate(
                      -size.width + _xControllerForDrawer.value * maxDrag)
...
class _Animation8State extends State<Animation8> {
  ...
  Widget build(BuildContext context) {
    return MyDrawer(
      ...
      child: Scaffold(
        appBar: AppBar(title: const Text('Scaffold Body')),
        body: Container(color: Colors.pink.shade300),
      ),
    );
  }
}
